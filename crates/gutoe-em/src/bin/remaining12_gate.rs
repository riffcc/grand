...
struct AbsoluteChecks {
    electron_ok: bool,
    electron_planck_ok: bool,
    vev_ok: bool,
    lattice_masses_ok: bool,
    planck_structural_masses_ok: bool,
...
struct AbsoluteMetrics {
    ...
    electron_planck_rel_err: f64,
    vev_rel_err: f64,
    m_w_lat_rel_err: f64,
    m_z_lat_rel_err: f64,
    m_h_lat_rel_err: f64,
    m_w_planck_rel_err: f64,
    m_z_planck_rel_err: f64,
    m_h_planck_rel_err: f64,
    m_w_fer_rel_err: f64,
    m_z_fer_rel_err: f64,
    m_h_fer_rel_err: f64,
}
...
fn main() {
    ...
    let s2 = 6.0 * k - 2.0;
    let k_nu_dressed_rel = rel_err(k, K_NU_DRESSED_CANDIDATE);
    ...
    let abs_splittings_ok =
        dm21_rel.abs() <= NEUTRINO_RATIO_TOL && dm32_rel.abs() <= NEUTRINO_RATIO_TOL;
    let k_nu_dressed_ok = k_nu_dressed_rel.abs() <= K_NU_DRESSED_TOL;
    ...
    let n_metrics = NeutrinoMetrics {
        ...
        koide_k: k,
        koide_s2: s2,
        k_nu_dressed_rel_err: k_nu_dressed_rel,
    ...
    let electron_planck_ok = pct_ok(me_planck_rel, SCALE_TOL);
    ...
    let planck_structural_masses_ok = pct_ok(m_w_planck_rel, SCALE_TOL)
        && pct_ok(m_z_planck_rel, SCALE_TOL)
        && pct_ok(m_h_planck_rel, SCALE_TOL);
    let fermi_masses_ok = pct_ok(m_w_fer_rel, SCALE_TOL)
        && pct_ok(m_z_fer_rel, SCALE_TOL)
        && pct_ok(m_h_fer_rel, SCALE_TOL);
    let a_overall = electron_ok
        && electron_planck_ok
        && vev_ok
        && lattice_masses_ok
    ...
    let a_metrics = AbsoluteMetrics {
        ...
        electron_planck_rel_err: me_planck_rel,
        vev_rel_err: v_rel,
        m_w_lat_rel_err: m_w_lat_rel,
        m_z_lat_rel_err: m_z_lat_rel,
        m_h_lat_rel_err: m_h_lat_rel,
        m_w_planck_rel_err: m_w_planck_rel,
        m_z_planck_rel_err: m_z_planck_rel,
        m_h_planck_rel_err: m_h_planck_rel,
    ...
    writeln!(
        txt,
        "hierarchy_ok={} tiny_ok={} ratio_ok={} abs_splittings_ok={} k_nu_dressed_ok={} no_fit_pass={} tri_ratio_ok={} tri_abs_ok={} triangulated_pass={}",
        ...
        report.neutrino.checks.k_nu_dressed_ok,
    ...
    writeln!(
        txt,
        "dm21_rel={:+.6e} dm32_rel={:+.6e} ratio_rel={:+.6e} K={:.12e} s2={:.12e} K_vs_7_12_rel={:+.6e} p_tri={:.12e}",
        ...
        report.neutrino.metrics.k_nu_dressed_rel_err,
    ...
    writeln!(
        txt,
        "electron_ok={} electron_planck_ok={} vev_ok={} lattice_masses_ok={} planck_structural_masses_ok={} fermi_masses_ok={} overall={}",
        report.absolute_scale.checks.electron_ok,
        report.absolute_scale.checks.electron_planck_ok,
        report.absolute_scale.checks.vev_ok,
        report.absolute_scale.checks.lattice_masses_ok,
        report.absolute_scale.checks.planck_structural_masses_ok,
    ...
    writeln!(
        txt,
        "electron_rel={:+.6e} electron_planck_rel={:+.6e} vev_rel={:+.6e} mW_lat_rel={:+.6e} mZ_lat_rel={:+.6e} mH_lat_rel={:+.6e} mW_planck_rel={:+.6e} mZ_planck_rel={:+.6e} mH_planck_rel={:+.6e} mW_fer_rel={:+.6e} mZ_fer_rel={:+.6e} mH_fer_rel={:+.6e}",
        report.absolute_scale.metrics.electron_rel_err,
        report.absolute_scale.metrics.electron_planck_rel_err,
        ...
        report.absolute_scale.metrics.m_w_planck_rel_err,
        report.absolute_scale.metrics.m_z_planck_rel_err,
        report.absolute_scale.metrics.m_h_planck_rel_err,
