...
const ZETA_ZERO_IMAG_FIRST_120_TXT: &str = include_str!("../data/zeta_zeros_first_120.txt");
...
pub fn zeta_zero_reference() -> &'static [f64] {
    static ZEROS: OnceLock<Vec<f64>> = OnceLock::new();
    ZEROS
        .get_or_init(|| {
            ZETA_ZERO_IMAG_FIRST_120_TXT
                .lines()
