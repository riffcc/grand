...
impl RateEngine {
    pub fn baseline_p1() -> Self {
        ...
        let tables = vec![
            ...
            table("cno_1", &[(0.01, 1.0e-25), (0.02, 1.0e-21), (0.05, 8.0e-16)]),
            table("cno_2", &[(0.01, 5.0e-11), (0.02, 5.5e-11), (0.05, 6.0e-11)]),
            table("cno_3", &[(0.01, 2.0e-24), (0.02, 6.0e-21), (0.05, 2.0e-15)]),
            table("cno_4", &[(0.01, 1.0e-28), (0.02, 5.0e-24), (0.05, 6.0e-18)]),
            table("cno_5", &[(0.01, 2.0e-9), (0.02, 2.2e-9), (0.05, 2.5e-9)]),
            table("cno_6", &[(0.01, 1.0e-23), (0.02, 3.0e-20), (0.05, 9.0e-15)]),
            table(
                "triple_alpha",
